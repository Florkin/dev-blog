...
$(".js-confirm-delete").on("click",function(){var t=$(this).attr("data-href");$("#confirm-delete .btn-ok").attr({href:t})});
/*!
 * Start Bootstrap - Clean Blog v5.0.9 (https://startbootstrap.com/themes/clean-blog)
 * Copyright 2013-2020 Start Bootstrap
 * Licensed under MIT (https://github.com/StartBootstrap/startbootstrap-clean-blog/blob/master/LICENSE)
...
setTimeout(function(){$(".messages").hide("slow")},8e3),$(".messages .message").on("click",function(){$(this).remove()});
/*!
 * Start Bootstrap - Clean Blog v5.0.9 (https://startbootstrap.com/themes/clean-blog)
 * Copyright 2013-2020 Start Bootstrap
 * Licensed under MIT (https://github.com/StartBootstrap/startbootstrap-clean-blog/blob/master/LICENSE)
...
$(document).ready(function(){$("textarea#tinymce").length&&tinymce.init({selector:"textarea#tinymce",language:"fr",height:300,menubar:!1,statusbar:!1,plugins:"code image table link media codesample",toolbar:"undo redo styleselect bold italic alignleft aligncenter alignright bullist numlist outdent indent format code image table link imagetools media codesample",setup:function(e){e.on("change",function(){tinymce.triggerSave()})}})});
/*!
 * Start Bootstrap - Clean Blog v5.0.9 (https://startbootstrap.com/themes/clean-blog)
 * Copyright 2013-2020 Start Bootstrap
 * Licensed under MIT (https://github.com/StartBootstrap/startbootstrap-clean-blog/blob/master/LICENSE)
...
$("#menu-toggle").click(function(e){e.preventDefault(),$("#wrapper").toggleClass("toggled"),$("#wrapper").hasClass("toggled")?$("#menu-toggle").text("fermer"):$("#menu-toggle").text("Menu")});